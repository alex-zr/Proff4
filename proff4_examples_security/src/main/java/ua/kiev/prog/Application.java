...
/*
    ...
    1. Добавить функцию логаут
    2. Добавить кнопку перехода на админскую панель
    3. Добавить на админской панеле вывод всех пользователей (управление пользователями)
